...
const ROLE_THEMES: Record<Role, RoleTheme> = {
  brand: {
    ...
    profileHeaderButton: "bg-background text-role-navy hover:bg-role-navy-50",
    profileOutlineButton: "border border-role-navy/25 bg-background text-role-navy hover:bg-role-navy-50",
  ...
  agency: {
    ...
    profileHeaderButton: "bg-background text-emerald-800 hover:bg-emerald-50",
    profileOutlineButton: "border border-emerald-300 bg-background text-emerald-800 hover:bg-emerald-50",
  ...
  influencer: {
    ...
    profileHeaderButton: "bg-background text-foreground hover:bg-role-coral-50",
    profileOutlineButton: "border border-role-coral/30 bg-background text-foreground hover:bg-role-coral-50",
    profileNotice: "border border-role-coral/25 bg-role-coral-50 text-foreground"
  }
};
