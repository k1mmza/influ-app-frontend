...
export function LandingHero() {
  ...
  return (
    <section className="relative flex min-h-[600px] w-full flex-col items-center justify-center overflow-hidden rounded-[2.5rem] bg-slate-950 px-4 py-20 lg:min-h-[calc(100vh-8rem)]">
            ...
            <div className="relative flex flex-col gap-3 sm:flex-row sm:items-center">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="h-14 rounded-2xl border-white/10 bg-white/5 pl-12 pr-4 text-white placeholder:text-slate-500 backdrop-blur-md transition-all focus:border-primary/50 focus:ring-primary/20"
                />
              </div>
